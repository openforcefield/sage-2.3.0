...
suffixs = ['openff_unconstrained-2.1.0_grp_confs','openff_unconstrained-2.2.1_confs' , 'openff_unconstrained-2.2.1-sdata_confs','openff_unconstrained-2.2.1-tm-sdata_confs']
...
labels = ['Sage 2.1.0 (regroup)','Sage 2.2.1','Sage 2.2.1-sdata' ,'Sage 2.2.1-tm-sdata']
# labels = suffixs
...
for i,bond in enumerate(angles):
    ...
    plot_hist(bond_errs_x,labels,filename='params_incl210_grp_confs/'+bond+ '_hist.pdf',title=bond + ' ' + smirks,xlab='Angle error (deg)',xlim=[-25,25])
    boxplot(bond_errs_x,labels,filename='params_incl210_grp_confs/'+bond+ '_boxplot.pdf',title=bond + ' ' + smirks ,ylab = 'Angle error (deg)')
