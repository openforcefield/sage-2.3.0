...
python filter_dataset_parallel.py \
    ...
    --input                         "OpenFF Torsion Multiplicity Optimization Benchmarking Coverage Supplement v1.0" \
    --input                         "OpenFF Torsion Benchmark Supplement v1.0" \
    --output                        "datasets/OpenFF-Industry-v1.1-Sulfur-v1.0-2TM-v1.0-chargecoverage.json"         \
