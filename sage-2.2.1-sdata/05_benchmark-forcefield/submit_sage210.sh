...
python -u  benchmark.py -f "openff_unconstrained-2.1.0.offxml" -d "datasets/OpenFF-Industry-v1.1-Sulfur-v1.0-chargecoverage-cache.json" -s "openff_unconstrained-2.1.0.sqlite" -o $savedir --procs 16
